...
def calculate_demographic_data(print_data=True):
    ...
    percentage_advanced_education = round((df[higher_education]['salary'] == '>50K').mean() * 100, 1)
    # What percentage of people without advanced education make more than 50K?
    percentage_lower_education = round((df[lower_education]['salary'] == '>50K').mean() * 100, 1)
